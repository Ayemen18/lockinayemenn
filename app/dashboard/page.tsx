...
export default function DashboardPage() {
  ...
  return (
    <div className="text-neutral-100 space-y-6 font-sans">
      <div>

        {/* Header */}
        <FadeIn className="flex items-end justify-between pb-4">
          <div>
        ...
        {/* Widescreen Telemetry Cockpit Layout Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start">
          
          {/* Left Column: Primary Execution Console (3/5 width) */}
          <div className="lg:col-span-3 space-y-6">
            
            {/* Today Checklist Card — Expanded widescreen HUD */}
            <FadeIn>
              <div className={`premium-card backdrop-blur-lg border shadow-[0_8px_32px_rgba(0,0,0,0.65)] rounded-2xl p-5 relative overflow-hidden ${
                forecastMode 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 relative z-10">
                  ...
                  <div className="flex flex-col justify-between h-full border-l border-neutral-800/40 pl-5 min-h-[200px]">
                    <div>
                      <div className="flex items-center justify-between mb-3">
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs font-mono truncate max-w-[120px]">{habit.name}</span>
                              </div>
            ...
            {/* Sub-Grid: Telemetry Charts (Heatmap + Bar Chart side-by-side) */}
            <FadeIn delay={0.1}>
              <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
                ...
                {/* 7-Day Bar Chart (2/5 width on xl) */}
                <div className="xl:col-span-2 premium-card bg-neutral-950/30 backdrop-blur-lg border border-neutral-900/40 shadow-[0_8px_32px_rgba(0,0,0,0.65)] rounded-2xl p-5">
            ...
            {/* Behavioral Insights & Diagnostic Feed */}
            <FadeIn delay={0.15}>
          ...
          {/* Right Column: Sidebar Telemetry (2/5 width) */}
          <div className="lg:col-span-2 space-y-6">
            
            {/* Quick Stats Row — Consolidates Streak, Avg, Consistency side-by-side */}
            <FadeInStagger className="grid grid-cols-3 gap-3">
              
              {/* Streak Card */}
              <StaggerItem>
                <div className="premium-card bg-neutral-950/30 backdrop-blur-lg border border-neutral-900/40 shadow-[0_8px_32px_rgba(0,0,0,0.65)] rounded-xl p-4 h-full flex flex-col justify-between relative overflow-hidden min-h-[100px]">
                  {streak > 0 && (
                  ...
                  <div className="flex items-center justify-between z-10">
                    <p className="text-[9px] text-neutral-500 font-mono uppercase tracking-widest">Streak</p>
                    {streak > 0 && <span className="text-xs animate-pulse">🔥</span>}
                  </div>
                  <div className="z-10 mt-2">
                    <div className="flex items-baseline gap-0.5">
                      <span className="text-2xl font-extrabold text-white tracking-tight font-mono drop-shadow-[0_0_6px_rgba(255,255,255,0.08)]">{streak}</span>
                      <span className="text-neutral-550 text-[9px] font-mono uppercase">days</span>
                    </div>
                  </div>
                </div>
              </StaggerItem>
              ...
              {/* Avg Score Card */}
              <StaggerItem>
                <div className="premium-card bg-neutral-950/30 backdrop-blur-lg border border-neutral-900/40 shadow-[0_8px_32px_rgba(0,0,0,0.65)] rounded-xl p-4 h-full flex flex-col justify-between min-h-[100px]">
                  <p className="text-[9px] text-neutral-500 font-mono uppercase tracking-widest">Avg score</p>
                  <p className="text-2xl font-extrabold text-white tracking-tight font-mono drop-shadow-[0_0_6px_rgba(255,255,255,0.08)] mt-2">{avgScore}%</p>
                </div>
              </StaggerItem>
              ...
              <StaggerItem>
                <div className="premium-card bg-neutral-950/30 backdrop-blur-lg border border-neutral-900/40 shadow-[0_8px_32px_rgba(0,0,0,0.65)] rounded-xl p-4 h-full flex flex-col justify-between min-h-[100px]">
                  <p className="text-[9px] text-neutral-500 font-mono uppercase tracking-widest">Consistency</p>
                  <p className="text-2xl font-extrabold text-white tracking-tight font-mono drop-shadow-[0_0_6px_rgba(255,255,255,0.08)] mt-2">{consistency}%</p>
                </div>
              </StaggerItem>
              ...
              <div className="premium-card bg-neutral-950/30 backdrop-blur-lg border border-neutral-900/40 shadow-[0_8px_32px_rgba(0,0,0,0.65)] rounded-2xl p-5 relative overflow-hidden">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-neutral-650 font-mono mt-1 uppercase tracking-wide">Maintain 75%+ score to secure quota</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-neutral-650 font-mono mt-1 uppercase tracking-wide">Log habits in 5+ distinct areas today</p>
                  </div>
                </div>
              </div>
            </FadeIn>
            ...
            {/* Recent Reflections Timeline Feed */}
            {logs.filter(l => l.reflection).length > 0 && (
              <FadeIn delay={0.3}>
                ...
                <div className="relative border-l border-neutral-900/60 ml-2.5 pl-5 space-y-4">
                  {[...logs].reverse().filter(l => l.reflection).slice(0, 3).map((log) => (
                    <div key={log.date} className="relative group">
                      {/* Timeline bullet node */}
                      <div className={`absolute -left-[27px] top-1.5 w-3.5 h-3.5 rounded-full border-2 bg-black z-10 transition-colors duration-300 ${
                        log.score >= 80 ? 'border-emerald-500 shadow-[0_0_6px_rgba(16,185,129,0.4)]' :
                        log.score >= 60 ? 'border-amber-500 shadow-[0_0_6px_rgba(245,158,11,0.3)]' :
                        'border-rose-500 shadow-[0_0_6px_rgba(244,63,94,0.4)]'
                      }`} />
                      
                      <div className="premium-card bg-neutral-950/20 backdrop-blur-md border border-neutral-900/40 hover:border-neutral-800/40 hover:bg-neutral-900/10 rounded-xl p-4.5 transition-all duration-300">
                        <div className="flex items-center justify-between mb-1.5">
                          <span className="text-[10px] text-neutral-450 font-mono uppercase tracking-wide font-semibold">[ LOG: ${log.date} ]</span>
                          <span className={`text-[8px] px-1.5 py-0.5 rounded-full font-mono font-extrabold uppercase tracking-wide ${
                        ...
                        <p className="text-xs text-neutral-350 italic leading-relaxed font-sans pl-2 border-l border-neutral-800">
                          "${log.reflection}"
                        </p>
                      </div>
                    </div>
